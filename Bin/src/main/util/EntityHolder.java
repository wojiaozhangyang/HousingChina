...
public class EntityHolder {
	static ArrayList<HostileEntity> e = new ArrayList<HostileEntity>();		//敌方BOSS
	static ArrayList<Block> b = new ArrayList<Block>();						//墙块体
	static ArrayList<ItemEntity> s = new ArrayList<ItemEntity>();			//游戏里面实物
	static ArrayList<AbsProjectile> p = new ArrayList<AbsProjectile>();		//子弹属性
	static ArrayList<AbsProjectile> ep = new ArrayList<AbsProjectile>();
	static ArrayList<Particle> pa = new ArrayList<Particle>();				//粒子
