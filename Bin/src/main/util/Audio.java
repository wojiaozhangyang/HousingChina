...
public class Audio {
	...
	public Audio(){
		if(sounds == null){
			playerHurt = new sound(Audio.class.getResource("/Audio/PlayerHurt.wav"),3);					//人物受伤
			basicWand = new sound(Audio.class.getResource("/Audio/basicWand.wav"),3);
			rapidWand = new sound(Audio.class.getResource("/Audio/RapidWand.wav"),3);					//快速棒子
			death = new sound(Audio.class.getResource("/Audio/Death.wav"),3);							//死亡
			fireballExplosion = new sound(Audio.class.getResource("/Audio/FireballExplosion.wav"),3);	//技能爆炸
